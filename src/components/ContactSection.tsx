        ...
        >
          ...
          {submitted ? (
            <div className="bg-card border border-primary/30 p-8 text-center">
              <p className="text-xl font-semibold mb-2 text-primary">{t("contact.success.title")}</p>
              <p className="text-muted-foreground">{t("contact.success.text")}</p>
            </div>
          ) : (
